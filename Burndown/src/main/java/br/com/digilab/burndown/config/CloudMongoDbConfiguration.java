...
import br.com.digilab.burndown.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("br.com.digilab.burndown.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("br.com.digilab.burndown.config.dbmigrations");
